  ...
  return (
    <>
      <header className="fixed inset-x-0 top-0 z-50 border-b border-white/10 bg-deepBlue/82 text-white backdrop-blur-xl">
        <div className="grid h-20 w-full grid-cols-[auto_1fr_auto] items-center gap-5 px-10 min-[1440px]:px-14">
          <Link href="/" className="group flex items-center gap-3" onClick={closeMenus}>
            <img className="h-14 w-14 object-contain" src="/images/logo-vvh.png" alt="Việt Văn Hiến" />
          </Link>
          ...
          <div className="flex items-center justify-end">
            ...
            <div className="flex items-center gap-3 lg:hidden">
              <LanguageSwitcher />
              <button className="rounded-lg border border-white/15 p-2 text-white" onClick={() => setMobileOpen((value) => !value)} title={locale === 'en' ? 'Open menu' : 'Mở menu'}>
